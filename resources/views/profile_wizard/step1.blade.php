    ...
    <div class="flex-grow flex items-center justify-center min-h-screen py-12 px-4 sm:px-6 lg:px-8">
        <div class="w-full max-w-2xl space-y-8">
            <div class="bg-white p-8 shadow-card rounded-xl">
                ...
                <!-- Formulario -->
                <form action="{{ route('profile.wizard.step1') }}" method="POST" class="space-y-6" enctype="multipart/form-data">
                    @csrf
                    ...
                    <!-- Estado Civil -->
                    <div>
                        <label for="civil_status" class="block text-sm font-medium text-gray-700 mb-1">Estado Civil</label>
                        <select
                            name="civil_status"
                            id="civil_status"
                        ...
                        >
                            ...
                            <option value="S" {{ old('civil_status') == 'S' ? 'selected' : '' }}>Soltero/a</option>
                            <option value="C" {{ old('civil_status') == 'C' ? 'selected' : '' }}>Casado/a</option>
                            <option value="V" {{ old('civil_status') == 'V' ? 'selected' : '' }}>Viudo/a</option>
                            <option value="D" {{ old('civil_status') == 'D' ? 'selected' : '' }}>Divorciado/a</option>
                        </select>
                        @error('civil_status')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input
                            ...
                            placeholder="Ej: Av. Arequipa 123, Oficina 456"
                            value="{{ old('address') }}"
                        />
                        @error('address')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    ...
                    <!-- Foto de Perfil -->
                    <div>
                        <label for="photo" class="block text-sm font-medium text-gray-700 mb-1">Foto de Perfil (Opcional)</label>
                        <input
                            type="file"
                            name="photo"
                            id="photo"
