                ...
                <form action="{{ route('profile.wizard.step2') }}" method="POST" class="space-y-6">
                    ...
                    @if(auth()->user()->role->name === 'doctor')
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                <label for="license_code" class="block text-sm font-medium text-gray-700 mb-1">Código de Colegiatura *</label>
                                <input
                                    type="text"
                                    name="license_code"
                                    id="license_code"
                            ...
                            <div>
                                <label for="professional_bio" class="block text-sm font-medium text-gray-700 mb-1">Biografía Profesional</label>
                                <textarea
                                    ...
                                    placeholder="Describa su experiencia profesional, formación académica, áreas de especialización..."
                                >{{ old('professional_bio') }}</textarea>
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    placeholder="Liste sus alergias conocidas (medicamentos, alimentos, etc.)"
                            ...
                            <!-- Vacunas Recibidas -->
                            <div>
                                <label for="vaccination_received" class="block text-sm font-medium text-gray-700 mb-1">Vacunas Recibidas</label>
                                <textarea
                                    name="vaccination_received"
                                    id="vaccination_received"
                                    rows="3"
                                    ...
                                    placeholder="Liste las vacunas que ha recibido y sus fechas"
                                >{{ old('vaccination_received') }}</textarea>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label for="emergency_contact" class="block text-sm font-medium text-gray-700 mb-1">Contacto de Emergencia</label>
                                    <input
                                        type="text"
                                ...
                                <div>
                                    <label for="emergency_phone" class="block text-sm font-medium text-gray-700 mb-1">Teléfono de Emergencia</label>
                                    <input
                                        type="tel"
                    ...
                    <div class="flex justify-between pt-6">
                        ...
                        >
                            <span class="btn-icon material-icons text-blue-500 group-hover:text-blue-400">arrow_forward</span>
                            Siguiente
                        </button>
                    </div>
                </form>
