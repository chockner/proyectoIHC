...
@section('content')
    <div class="container mt-4">
        <h3 class="text-center mb-4 fw-bold">EDITAR PACIENTE</h3>
        <hr>
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="document_id" id="document_id" maxlength="8"
                            ...
                            value="{{ old('document_id', $paciente->user->document_id ?? '') }}"
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="phone" id="phone" maxlength="9"
                            ...
                            "
                            value="{{ old('phone', $paciente->user->profile->phone ?? '') }}"
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" name="birthdate" id="birthdate"
                            value="{{ old('birthdate', isset($paciente->user->profile->birthdate) ? $paciente->user->profile->birthdate->format('Y-m-d') : '') }}"
                            required>
                        @error('birthdate')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="mb-3">
                        ...
                        <select name="gender" id="gender" class="form-select" required>
                            ...
                            <option value="0" {{ old('gender', $paciente->user->profile->gender ?? '') == '0' ? 'selected' : '' }}>Masculino</option>
                            <option value="1" {{ old('gender', $paciente->user->profile->gender ?? '') == '1' ? 'selected' : '' }}>Femenino</option>
                        </select>
                        @error('gender')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <select name="civil_status" id="civil_status" class="form-select" required>
                            <option value="">Selecciona...</option>
                            <option value="0" {{ old('civil_status', $paciente->user->profile->civil_status ?? '') == '0' ? 'selected' : '' }}>Soltero(a)</option>
                            <option value="1" {{ old('civil_status', $paciente->user->profile->civil_status ?? '') == '1' ? 'selected' : '' }}>Casado(a)</option>
                            <option value="2" {{ old('civil_status', $paciente->user->profile->civil_status ?? '') == '2' ? 'selected' : '' }}>Viudo(a)</option>
                            <option value="3" {{ old('civil_status', $paciente->user->profile->civil_status ?? '') == '3' ? 'selected' : '' }}>Divorciado(a)</option>
                        </select>
                        @error('civil_status')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="address" id="address"
                            value="{{ old('address', $paciente->user->profile->address ?? '') }}" required>
                        @error('address')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
