                ...
                <div class="col-md-4">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="gender" id="gender" class="form-select" required>
                            ...
                            <option value="0"
                                {{ old('gender', $paciente->user->profile->gender ?? '') == '0' ? 'selected' : '' }}>
                                Masculino</option>
                            <option value="1"
                                {{ old('gender', $paciente->user->profile->gender ?? '') == '1' ? 'selected' : '' }}>
                                Femenino</option>
                        </select>
                        @error('gender')
                            <span class="text-danger">{{ $message }}</span>
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <select name="civil_status" id="civil_status" class="form-select" required>
                            <option value="">Selecciona...</option>
                            <option value="0"
                                {{ old('civil_status', $paciente->user->profile->civil_status ?? '') == '0' ? 'selected' : '' }}>
                                Soltero(a)</option>
                            <option value="1"
                                {{ old('civil_status', $paciente->user->profile->civil_status ?? '') == '1' ? 'selected' : '' }}>
                                Casado(a)</option>
                            <option value="2"
                                {{ old('civil_status', $paciente->user->profile->civil_status ?? '') == '2' ? 'selected' : '' }}>
                                Viudo(a)</option>
                            <option value="3"
                                {{ old('civil_status', $paciente->user->profile->civil_status ?? '') == '3' ? 'selected' : '' }}>
                                Divorciado(a)</option>
                        </select>
                        @error('civil_status')
                            <span class="text-danger">{{ $message }}</span>
