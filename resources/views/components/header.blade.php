            ...
            <div class="flex items-center gap-4">
                ...
                <div class="relative group">
                    ...
                    <div class="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 hidden group-hover:block">
                        <a class="block px-4 py-2 text-sm text-slate-600 hover:bg-blue-50 hover:text-blue-600" href="#">Mi Perfil</a>
                        <a class="block px-4 py-2 text-sm text-slate-600 hover:bg-blue-50 hover:text-blue-600" href="#">Configuración</a>
