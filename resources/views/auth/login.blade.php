    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            ...
            <form action="{{ route('login') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="document_id" id="document_id" maxlength="8"
                        inputmode="numeric" pattern="\d{8}" {{-- value="{{ old('document_id', optional($profile)->document_id ?? '') }}" --}} {{-- required --}}
            ...
            <div class="mt-3 text-center">
                <small>
                    <a href="{{ route('quick.reset.form') }}" class="text-decoration-none">¿Olvidaste tu contraseña?</a>
                </small>
            </div>
        </div>
    </div>
